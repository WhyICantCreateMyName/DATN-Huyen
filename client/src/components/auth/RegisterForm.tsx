    ...
    >
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-nude/30 rounded-full mb-6">
          <span className="text-[10px] font-black uppercase tracking-widest text-black">Gia nhập cộng đồng Yuki</span>
        </div>
        <h1 className="text-5xl font-black text-black tracking-tighter mb-4 uppercase">ĐĂNG KÝ</h1>
        <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">Tạo tài khoản để nhận ưu đãi đặc biệt</p>
      </div>
      ...
      <div className="bg-slate-50/50 backdrop-blur-xl border border-slate-100 p-10 rounded-[3rem] shadow-2xl shadow-slate-200/50">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-black transition-colors" />
              <input
                type="text"
                value={name}
        ...
        <div className="mt-10 text-center">
          <p className="text-slate-400 text-xs font-bold uppercase tracking-wider">
            Đã có tài khoản?{' '}
            <Link href="/login" className="text-black border-b-2 border-black pb-0.5 hover:text-accent hover:border-accent transition-all">
              Đăng nhập ngay
            </Link>
          </p>
        </div>
